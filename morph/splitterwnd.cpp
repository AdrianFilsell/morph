...
void splitterwnd::create(CWnd *pParent)
{
	...
	std::shared_ptr<dibwnd> spPane = std::shared_ptr<dibwnd>(new dibwnd(afmorph::morphcomponent::t_src));
	...
	spPane = std::shared_ptr<dibwnd>(new dibwnd(afmorph::morphcomponent::t_dst));
